...
import { etfCategories, etfList } from "@/constants";

const ETFs = () => {
  const [activeCategory, setActiveCategory] = useState("All ETFs");

  // Filter news articles based on the selected category
  const filteredNews =
    activeCategory === "All ETFs"
      ? etfList
      : etfList.filter((news) => news.category === activeCategory);

  return (
    <div className="bg-[#1A1F36] py-12 text-white">
      <div className="container mx-auto px-6">
        ...
        {/* Category Tabs */}
        <div className="flex h-[78px] justify-center space-x-6 mb-12 -skew-x-6 bg-[#2C2F33] rounded-lg border border-blue-500 shadow-lg">
